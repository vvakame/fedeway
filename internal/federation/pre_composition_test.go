...
func TestRequiresUsedOnBase(t *testing.T) {
	// test case are ported from federation-js/src/composition/validate/preComposition/__tests__/requiresUsedOnBase.test.ts

	const testFileDir = "./_testdata/validate/requiresUsedOnBase/assets"
	expectFileDir := "./_testdata/validate/requiresUsedOnBase/expected"

	rule := requiresUsedOnBase
...
func TestKeyFieldsMissingExternal(t *testing.T) {
	// test case are ported from federation-js/src/composition/validate/preComposition/__tests__/keyFieldsMissingExternal.test.ts

	const testFileDir = "./_testdata/validate/keyFieldsMissingExternal/assets"
	expectFileDir := "./_testdata/validate/keyFieldsMissingExternal/expected"
